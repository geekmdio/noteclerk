...
const (
	...
	DbPostgresAllNoteFragmentsFailsScanRow              = 43
	DbPostgresAllNoteFragmentsQueryFails                = 44
)
...
var ErrMapStr = map[NoteClerkError]string{
	...
	NoteClerkServerCreateNoteFailsAddNoteToDb:           "Server.CreateNote fails to add the new note to the database.",
	NoteClerkServerDeleteNoteFailsDeleteNoteFromDb:      "Server.DeleteNote fails to delete the requested note from the database.",
	NoteClerkServerRetrieveNoteFailsToGetNoteFromDb:     "Server.RetrieveNote fails to retrieve requested note from the database.",
	NoteClerkServerSearchNotesFailsToFindNotesInDb:      "Server.SearchNotes",
	NoteClerkServerUpdateNoteFailsDueToIdMismatch:       "Server.UpdateNote fails to update due to a mismatch between the Id of the presented note and the Id stated as the note to update.",
	NoteClerkServerUpdateNoteFailsToUpdateNoteInDb:      "Server.UpdateNote fails to update the note in the database.",
	NoteClerkServerInitializeFailsDbInitialization:      "Server.Initialize failed to initialize the database.",
	NoteClerkServerInitializeFailsCreateListener:        "Server.Initialize fails to create a listener.",
	NoteClerkServerInitializeFailsInitializingRpcServer: "Server.Initialize fails to create a gRPC server on the listener.",
	NoteClerkServerConstructorFailsDueToNilDb:           "Server.constructor fails to populate fields due to a nil database being received.",
	NoteClerkServerConstructorFailsDueToNilConfig:       "Server.constructor fails to populate fields due to a nil config being received.",
	...
	DbPostgresAllNoteFragmentsFailsScanRow:              "DbPostgres.AllNoteFragments failed to scan a row.",
	DbPostgresAllNoteFragmentsQueryFails:                "DbPostgres.AllNoteFragments failed query.",
}
